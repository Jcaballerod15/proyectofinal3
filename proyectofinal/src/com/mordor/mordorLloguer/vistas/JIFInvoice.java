...
public class JIFInvoice extends JInternalFrame {
	...
	*/
	...
	public JIFInvoice() throws PropertyVetoException {

		setFrameIcon(new ImageIcon(JIFInvoice.class.getResource("/com/mordor/mordorLloguer/recursos/invoice.png")));
		...
		btnNewInvoce.setIcon(
				new ImageIcon(JIFInvoice.class.getResource("/com/mordor/mordorLloguer/recursos/invoiceAdd.png")));
		...
		btnRemoveInvoice
				...
				.setIcon(new ImageIcon(
						JIFInvoice.class.getResource("/com/mordor/mordorLloguer/recursos/invoiceRemove.png")));
		...
		btnCheck.setIcon(new ImageIcon(JIFInvoice.class.getResource("/com/mordor/mordorLloguer/recursos/check.png")));
		...
		btnAddDetail.setIcon(new ImageIcon(JIFInvoice.class.getResource("/com/mordor/mordorLloguer/recursos/Add.png")));
		...
		btnRemoveDetail
				.setIcon(new ImageIcon(JIFInvoice.class.getResource("/com/mordor/mordorLloguer/recursos/Remove.png")));
		...
		btnPrint.setIcon(new ImageIcon(JIFInvoice.class.getResource("/com/mordor/mordorLloguer/recursos/Printer.png")));
		...
		btnPdf.setIcon(new ImageIcon(JIFInvoice.class.getResource("/com/mordor/mordorLloguer/recursos/pdf.png")));
		...
		btnPreviousInvoice.setIcon(
				new ImageIcon(JIFInvoice.class.getResource("/com/mordor/mordorLloguer/recursos/leftArrow.png")));
		...
		btnNextInvoice.setIcon(
				new ImageIcon(JIFInvoice.class.getResource("/com/mordor/mordorLloguer/recursos/rightArrow.png")));
